...
export const useNewsStore = defineStore('news', {
  ...
  actions: {
    ...
    async crearComunicacion(formData: FormData): Promise<any> {
      ...
      this.error = null;
      try {
        // Asumimos que apiService.crearComunicacion maneja la petición POST
        // a /api/v1/com con FormData y devuelve la respuesta del backend.
        const nuevaComunicacion = await apiService.crearComunicacion(formData);
